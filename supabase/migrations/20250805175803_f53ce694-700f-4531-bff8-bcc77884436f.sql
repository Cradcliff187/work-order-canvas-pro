...
-- Drop the existing function first to handle return type change
DROP FUNCTION IF EXISTS public.check_assignment_completion_status_enhanced(uuid);

-- Then create the new version with jsonb return type
