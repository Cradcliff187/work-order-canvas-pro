-- Phase 4/7: Update Database Triggers & Metadata Sync Functions (Fixed)
...
BEGIN
  ...
  LOOP
    ...
    SELECT trigger_jwt_metadata_sync(current_user_rec.user_id) INTO sync_result;
