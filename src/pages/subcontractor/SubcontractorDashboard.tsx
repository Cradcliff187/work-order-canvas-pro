  ...
  return (
    <div className="container mx-auto px-6 py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">View assigned work orders and submit completion reports</p>
      </div>
      ...
      <div className="text-center text-muted-foreground">
        <p>Subcontractor dashboard functionality will be implemented in future updates.</p>
      </div>
    </div>
  );
};
