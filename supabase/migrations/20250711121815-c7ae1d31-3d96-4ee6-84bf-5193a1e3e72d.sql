...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_work_order_assignments_assignee_type_combo 
ON public.work_order_assignments(assigned_to, assignment_type);

CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_work_order_assignments_wo_assignee_combo 
