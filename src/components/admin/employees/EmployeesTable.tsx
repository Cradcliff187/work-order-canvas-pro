...
export function EmployeesTable<TData = any>({
  data,
  columns,
  isLoading = false,
  emptyState,
  onRowClick,
}: EmployeesTableProps<TData>) {
  return (
    <Card className="p-4">
      {isLoading ? (
