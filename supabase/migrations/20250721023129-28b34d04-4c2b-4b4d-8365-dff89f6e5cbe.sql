...
-- Step 1: Clear all test data first
SELECT clear_test_data();

-- Step 2: Update generate_next_location_number to remove restriction
...
-- Step 3: Update generate_work_order_number_v2 to use per-location sequence counting
...
-- Step 4: Create test organizations with different scenarios
SELECT setup_bulletproof_test_data();

-- Step 5: Set up test organizations for both scenarios
UPDATE organizations 
