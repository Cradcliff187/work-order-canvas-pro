-- Update auth_user_belongs_to_organization() to use organization_members
...
-- Update jwt_organization_ids() to use organization_members  
...
-- Update auto_populate_assignment_organization() to use organization_members
