-- Migration: Comprehensive Subcontractor RLS Policies (Fixed)
-- This migration implements complete subcontractor access control across all tables
-- using the correct jwt_user_type() function
...
FOR SELECT
TO authenticated
USING (jwt_user_type() = 'subcontractor');
