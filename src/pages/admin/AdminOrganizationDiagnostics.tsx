...
const AdminOrganizationDiagnostics = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Organization Diagnostics</h1>
                          ...
                          actions={[
                            {
                              ...
                              show: user.user_type === 'subcontractor' && user.work_order_assignments?.length > 0
                            }
                          ]}
...
export default AdminOrganizationDiagnostics;