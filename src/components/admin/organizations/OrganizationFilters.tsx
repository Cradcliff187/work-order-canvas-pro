...
// OrganizationFilters: base shell following WorkOrders standard
...
export function OrganizationFilters({ value, onChange, className }: OrganizationFiltersProps) {
  return (
    <div className={clsx('w-full', className)}>
      <Card className="p-3 flex items-center gap-2">
        {/* TODO: Wire to debounced search + server filters. Keep parity with WorkOrders UX. */}
        <Input
          placeholder="Search organizations... (placeholder)"
