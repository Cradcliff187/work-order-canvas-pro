-- Create seed_test_data function with SECURITY DEFINER to bypass RLS
...
BEGIN
  ...
  INSERT INTO profiles (id, user_id, email, first_name, last_name, user_type, is_active, is_employee, hourly_cost_rate, hourly_billable_rate) VALUES
    (admin_user_id, v_user_id, 'admin@workorderpro.com', 'System', 'Administrator', 'admin', true, true, 75.00, 125.00),
