...
const createMockWorkOrder = (overrides?: Partial<WorkOrder>): WorkOrder => ({
  ...
  // All nullable fields - matching database schema exactly
  actual_completion_date: null,
  actual_hours: null,
  admin_completion_notes: null,
  auto_completion_blocked: null,
  city: null,
  ...
  internal_estimate_approved: null,
  internal_estimate_approved_at: null,
  internal_estimate_approved_by: null,
  internal_estimate_created_at: null,
  internal_estimate_created_by: null,
  internal_estimate_description: null,
  internal_estimate_notes: null,
  internal_markup_percentage: null,
  labor_cost: null,
  ...
  partner_estimate_approved_at: null,
  partner_estimate_rejection_notes: null,
  partner_location_number: null,
...
const createMockReport = (workOrderId: string): WorkOrderReport => ({
  ...
  approved_subcontractor_bill_amount: 100,
  bill_amount: 150,
  ...
  photos: null,
  // Required fields for work order report type
