...
interface AdminTimeEntryCreateModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSuccess?: () => void;
}

export function AdminTimeEntryCreateModal({ open, onOpenChange, onSuccess }: AdminTimeEntryCreateModalProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={createTimeEntry.isPending || isLoading || !selectedEmployeeData?.hourly_billable_rate}>
