-- Update get_partner_ready_bills function to include both 'ready' and 'paid' bills
-- This allows legacy paid bills to be available for partner invoicing
...
BEGIN
  ...
  WHERE sb.status IN ('approved', 'paid')
    AND sb.partner_billing_status IN ('ready', 'paid')
