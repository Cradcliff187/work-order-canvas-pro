...
DROP TRIGGER IF EXISTS auto_populate_assignment_organization_trigger ON work_order_assignments;
DROP FUNCTION IF EXISTS public.auto_populate_assignment_organization();

-- Drop and recreate other functions
...
CREATE TRIGGER auto_populate_assignment_organization_trigger
  BEFORE INSERT OR UPDATE ON work_order_assignments
  FOR EACH ROW
  EXECUTE FUNCTION auto_populate_assignment_organization();